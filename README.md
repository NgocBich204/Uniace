...
→ Power BI Dashboard
```
  ### 📌 Hình ảnh minh họa quy trình xử lý dữ liệu
...
- Chuẩn bị dữ liệu cho cleaning
  ### 📌 Hình ảnh minh họa dữ liệu sau khi import vào PostgreSQL 
...
- Kiểm tra dữ liệu bất thường
  ...
  ### 📌 Hình ảnh minh họa Kiểm tra Top Content đúng: chỉ Blog/Post, không có Account/Course/Home
...
- Theo dõi funnel conversion
 Theo dõi traffic website 
  ### 📌 Hình ảnh minh họa một visual 'theo dõi traffic website' trên dashboard
![alt text](<Picture/Ảnh chụp màn hình 2026-05-27 210906.png>)

## Data Dictionary

Data Dictionary được xây dựng nhằm cung cấp tài liệu tham chiếu cho toàn bộ hệ thống dữ liệu và các chỉ số phân tích trong dự án.
...
Thông qua Data Dictionary, người dùng có thể hiểu rõ cách dữ liệu được tổ chức, xử lý và sử dụng để xây dựng các chỉ số phục vụ phân tích Traffic, SEO Performance và User Journey.

 **View Full Data Dictionary:**  
📄 [View Detailed Data Dictionary](Uniace_Data_Dictionary.xlsx)

  ### 📌 Hình ảnh minh họa mô tả thông tin các bảng Fact/ dim trong Data Dictionary
![alt text](<Picture/03_48_10 PM.png>)

## Data Model

Dữ liệu sau khi làm sạch và chuyển đổi được tổ chức theo mô hình **Fact - Dimension**, giúp tối ưu hiệu suất phân tích và đảm bảo khả năng mở rộng của hệ thống báo cáo Power BI.

Mô hình dữ liệu được xây dựng nhằm phục vụ các bài toán phân tích:
...
| Table | Description |
|---------|-------------|
| `public_fact_events` | Bảng fact chính chứa toàn bộ website events sau xử lý |
| `public_dim_user` | Bảng dimension lưu thông tin người dùng |
| `public_dim_page` | Bảng dimension lưu thông tin trang truy cập và phân loại URL |
...
- Liên kết dữ liệu sự kiện với người dùng, trang truy cập và nguồn traffic.
- Tối ưu hiệu suất tính toán KPI trong Power BI.
- Hỗ trợ phân tích SEO, Content Performance và User Journey.
- Đảm bảo dữ liệu nhất quán và dễ dàng mở rộng khi phát triển dashboard.
- Đơn giản hóa việc xây dựng DAX Measures và Business Metrics.
  ### 📌 Hình ảnh minh họa mô hình dữ liệu 
...
| Blog → Course Rate | Blog & Course Users / Blog Users | Hiệu quả content |
  ### 📌 Hình ảnh minh họa các KPI được sử dụng 
